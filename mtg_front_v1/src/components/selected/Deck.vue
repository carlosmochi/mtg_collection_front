...
export default {
  ...
  methods: {
    ...
    getDeck(id) {
      DeckService.get(id)
          .then(response => {
            ...
            if(this.currentDeck.commander != null)
              this.commander = this.currentDeck.commander;
            else
              this.commander = {name: ''}
            this.newOwner = this.currentDeck.owner.fullName
    ...
    update() {
      ...
      DeckService.update(this.currentDeck.id, data)
          .then(response => {
            console.log("sent data")
            console.log(data)
            this.message = 'The Deck was updated successfully!';
            console.log(response.data);
          })
          .catch(e => {
            console.log(data);
      ...
      this.getDeck(this.currentDeck.id)
    },
    createNewCard(){
      return{
        card:{},
